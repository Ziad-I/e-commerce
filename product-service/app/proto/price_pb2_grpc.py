...
from app.proto import price_pb2 as price__pb2
...
class PriceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPrice = channel.unary_unary(
            ...
            response_deserializer=price__pb2.PriceResponse.FromString,
...
def add_PriceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetPrice": grpc.unary_unary_rpc_method_handler(
            ...
            response_serializer=price__pb2.PriceResponse.SerializeToString,
        ),
    }
...
class PriceService(object):
    ...
    def GetPrice(
        ...
        return grpc.experimental.unary_unary(
            ...
            price__pb2.PriceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
